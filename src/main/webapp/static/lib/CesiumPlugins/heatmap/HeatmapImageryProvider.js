/* 2017-10-21 11:18:37 | 修改 木遥（QQ：516584683） */
...
function createHeatmapImageryProvider(Cesium,options){
    ...
    var HeatmapImageryProvider = function(options) {
        ...
        var bounds = options.bounds || { "north": 90, "west": -180, "south": -90, "east": 180 };
        ...
        if (!Cesium.defined(data)) {
            ...
            throw new Cesium.DeveloperError('options.data.min, data.max, data.points  are required.');
        }

...
var plotlist = {
    //绘制
    _listData: [
        { "name": "线", "type": "polyline", "edittype": "polyline" }
    ],
    //开始绘制
...
var tableWork = {
    ...
    initEvent: function () {
        ...
        $table.bootstrapTable({
            ...
            iconsPrefix: 'fa',
            columns: [
                    { field: 'name', title: '名称', sortable: true, editable: false, align: 'left' },
                    {
...
var plotEdit = {
    ...
    updateLatlngsHtml: function (latlngs, cfg) {
        ...
        if (!latlngs || latlngs.length == 0) {
            ...
            var speed = this._last_attr.speed;
            var defSpeed = $("#txtFlySpeedAll").val();
            ...
            for (var idx = 0; idx < latlngs.length; idx++) {
                ...
                if (idx != latlngs.length - 1) {
                    var _speed = speed ? speed[idx] : defSpeed;

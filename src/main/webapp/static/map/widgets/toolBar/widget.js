...
var toolBar = mars3d.widget.bindClass(mars3d.widget.BaseWidget.extend({
    ...
    winCreateOK: function (opt, result) {
        ...
        $(".btn-toolbar .widget-btn").each(function () {
    ...
    initBasemaps: function () {
        ...
        $('#chkTerrain input[type="checkbox"]').prop('checked', viewer.mars.hasTerrain());
    },
    onThumbnailClk: function (evt) {
        ...
        //隐藏图层控制
        mars3d.widget.disable('/we3dGIS/static/map/widgets/manageLayers/widget.js');

...
mars3d.widget.bindClass(mars3d.widget.BaseWidget.extend({
    ...
    addPipeline: function (json, name) {
        var that = this;
        ...
        for (var i = 0; i < entities.length; i++) {
            ...
            var entitie = viewer.entities.add({
                ...
                polylineVolume: {
                    ...
                    material: new Cesium.Color.fromCssColorString("#651112").withAlpha(0.8)
                },
                popup: {
                    html: inhtml,
    ...
    updateTerrainHeight: function (arrEntitie) {
        var that = this;
        var index = 0;
        function getLineFD() {
    ...
    bindEvent: function () {
        ...
        //        var color = new Cesium.Color.fromCssColorString("#0000FF").withAlpha(0.8);
        ...
        //            debugger
        //            var color = new Cesium.Color.fromCssColorString("#FF0000").withAlpha(0.8);
        //            highlightedEntity.polylineVolume.material.color.setValue(color);
        //        }
        //    }
